...
//multi-type array
var values:(string | number)[]=["apple", "mango", 100];
console.log(values);
//or
var values:Array<string|number>=["apple", 80]
console.log(values);

// read data from array
var fruits10:string[]=["apple", "orange", "banana"];
...
var myarr:number[][]=[[50, 50], [30, 40], [82, 40]]
console.log(myarr);

var myarr1:(string | number)[][] = [[10,"xyz"], [525, "str"]]
console.log(myarr1);
